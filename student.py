...
#first image
        img=Image.open(r"C:\Users\MYPC\Desktop\FR_Images\s1.jpg")
        img=img.resize((460,100),Image.ANTIALIAS) #Antialias convertss high level image to low level image
        self.photoimg=ImageTk.PhotoImage(img)

        #making a label
        f_lbl=Label(self.root,image=self.photoimg)
        f_lbl.place(x=0,y=0,width=460,height=100)

#second image
        img1=Image.open(r"C:\Users\MYPC\Desktop\FR_Images\s2.jpg")
        img1=img1.resize((460,100),Image.ANTIALIAS) #Antialias convertss high level image to low level image
        self.photoimg1=ImageTk.PhotoImage(img1)

        #making a label
        f_lbl=Label(self.root,image=self.photoimg1)
        f_lbl.place(x=460,y=0,width=460,height=100)

#third image
        img2=Image.open(r"C:\Users\MYPC\Desktop\FR_Images\s3.jpg")
        img2=img2.resize((460,100),Image.ANTIALIAS) #Antialias convertss high level image to low level image
...
#bg image      
        ...
        title_lbl=Label(bg_image,text="STUDENT MANAGEMENT SYSTEM",font=("times new roman",30,"bold"),bg="dark blue",fg="white")
        title_lbl.place(x=0,y=0,width=1360,height=35)

        main_frame=Frame(bg_image,bd=2,bg="white")
        main_frame.place(x=10,y=40,width=1330,height=630)

        #left label frame
        left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("times new roman",12,"bold"))
        left_frame.place(x=10,y=10,width=630,height=540)

        img_left=Image.open(r"C:\Users\MYPC\Desktop\FR_Images\s3.jpg")
...
#current course information
        ...
        current_course_frame.place(x=5,y=105,width=620,height=120)
...
#Department
        ...
        dep_combo["values"]=("Select Department","Computer Science","Mechanical","Civil","Biotech","Electrical","Agriculture")
        dep_combo.current(0)
...
#Course
        ...
        course_combo["values"]=("Select Course","BTech","BCA","BSC")
...
#Semester
 ...
 #class student information
        ...
        class_student_frame.place(x=5,y=235,width=620,height=280)

        #studentid
        studentId_label=Label(class_student_frame,text="Student ID:",font=("times new roman",12,"bold"),bg="white")
        studentId_label.grid(row=0,column=0,padx=10,pady=5,sticky=W)

        studentId_entry=ttk.Entry(class_student_frame,textvariable=self.var_std_id,width=18,font=("times new roman",12,"bold"))
        ...
        div_combo=ttk.Combobox(class_student_frame,textvariable=self.var_div,font=("times new roman",12,"bold"),state="read only",width=16)
        ...
        gender_combo=ttk.Combobox(class_student_frame,textvariable=self.var_gender,font=("times new roman",12,"bold"),state="read only",width=16)
        ...
        address_entry=ttk.Entry(class_student_frame,textvariable=self.var_address,width=18,font=("times new roman",12,"bold"))
        ...
        teacher_entry=ttk.Entry(class_student_frame,textvariable=self.var_teacher,width=18,font=("times new roman",12,"bold"))
        ...
        btn_frame.place(x=0,y=200,width=615,height=55)
        ...
        btn_frame1.place(x=0,y=230,width=615,height=25)
        ...
        right_frame.place(x=670,y=10,width=630,height=530)

        img_right=Image.open(r"C:\Users\MYPC\Desktop\FR_Images\s3.jpg")
        img_right=img_right.resize((630,100),Image.ANTIALIAS) #Antialias convertss high level image to low level image
...
#================Search System====================
        ...
        search_frame.place(x=5,y=105,width=620,height=70)

        search_label=Label(search_frame,text="Search By:",font=("times new roman",12,"bold"),bg="white")
        search_label.grid(row=0,column=0,padx=10,pady=5,sticky=W)

        search_combo=ttk.Combobox(search_frame,font=("times new roman",12,"bold"),state="read only",width=17)
        ...
        table_frame.place(x=5,y=185,width=620,height=320)
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                def face_cropped(img):
                    ...
                    #1.3-Scaling factor default's value
                    #Minimum neighbor = 5
